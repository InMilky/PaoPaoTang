...
public class GameJFrame extends JFrame{
	public static int GameX = 900;//静态应该写成GAMEX,现在自己使用不做要求
	...
	public void init(){
		...
		this.setLocationRelativeTo(null);//屏幕显示居中
	}
	
	/* 窗体布局：存档，读档的button... 给大家扩展的*/
	...
	/**
	 * @set注入：等到大家学习ssm 通过set方法注入配置文件中读取的数据；
	 *         将配置文件中的数据赋值为类的属性
	 *  构造注入：需要配合构造方法
